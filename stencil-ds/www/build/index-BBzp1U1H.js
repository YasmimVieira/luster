const NAMESPACE = 'luster';
const BUILD = /* luster */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, constructableCSS: false, cssAnnotations: true, deserializer: false, devTools: true, element: false, event: true, experimentalScopedSlotChanges: false, experimentalSlotFixes: false, formAssociated: false, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, hydratedSelectorName: "hydrated", initializeNextTick: false, invisiblePrehydration: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: true, profile: true, prop: true, propBoolean: true, propChangeCallback: true, propMutable: true, propNumber: false, propString: true, reflect: false, scoped: false, scopedSlotTextContentFix: false, scriptDataOpts: false, serializer: false, shadowDelegatesFocus: false, shadowDom: true, shadowSlotAssignmentManual: false, slot: true, slotChildNodesFix: false, slotRelocation: false, state: true, style: true, svg: true, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: false, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: false };
const Env = /* luster */ {};

const globalScripts = () => {};
const globalStyles = "@import url('https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800&family=Inter:wght@300;400;500;600&display=swap');\n\n:root {\n  /* === SURFACES === */\n  --dc-surface:                   #060e20;\n  --dc-surface-container-lowest:  #030914;\n  --dc-surface-container-low:     #091328;\n  --dc-surface-container:         #0d1a35;\n  --dc-surface-container-high:    #141f38;\n  --dc-surface-container-highest: #192540;\n  --dc-surface-bright:            #1e2e4a;\n\n  /* === PRIMARY === */\n  --dc-primary:           #a3a6ff;\n  --dc-primary-dim:       #6063ee;\n  --dc-primary-fixed:     #cfd0ff;\n  --dc-on-primary:        #0a0040;\n  --dc-primary-container: #2b2dad;\n\n  /* === ON SURFACE === */\n  --dc-on-surface:         #dee5ff;\n  --dc-on-surface-variant: #a3aac4;\n\n  /* === OUTLINE === */\n  --dc-outline:         #616984;\n  --dc-outline-variant: #40485d;\n\n  /* === ERROR === */\n  --dc-error:              #ffb4ab;\n  --dc-error-container:    #93000a;\n  --dc-on-error-container: #ffdad6;\n\n  /* === SECONDARY === */\n  --dc-secondary:           #b6aee4;\n  --dc-secondary-container: #353065;\n\n  /* === TERTIARY === */\n  --dc-tertiary: #e8b4c8;\n\n  /* === SEMANTIC === */\n  --dc-success:           #4cceac;\n  --dc-success-container: #1a3d35;\n  --dc-warning:           #ffd166;\n  --dc-warning-container: #3d3000;\n\n  /* === TYPOGRAPHY === */\n  --dc-font-display: 'Manrope', sans-serif;\n  --dc-font-body:    'Inter', sans-serif;\n\n  --dc-display-lg: clamp(2.5rem, 5vw, 4.5rem);\n  --dc-display-md: clamp(2rem, 4vw, 3rem);\n  --dc-display-sm: clamp(1.5rem, 3vw, 2.25rem);\n\n  --dc-headline-lg: 2rem;\n  --dc-headline-md: 1.75rem;\n  --dc-headline-sm: 1.375rem;\n\n  --dc-title-lg: 1.25rem;\n  --dc-title-md: 1rem;\n  --dc-title-sm: 0.875rem;\n\n  --dc-body-lg:  1rem;\n  --dc-body-md:  0.875rem;\n  --dc-body-sm:  0.75rem;\n\n  --dc-label-lg:  0.875rem;\n  --dc-label-md:  0.75rem;\n  --dc-label-sm:  0.6875rem;\n\n  --dc-tracking-tight:  -0.02em;\n  --dc-tracking-normal: 0em;\n  --dc-tracking-wide:   0.08em;\n  --dc-tracking-wider:  0.12em;\n\n  /* === SPACING === */\n  --dc-space-1:  0.25rem;\n  --dc-space-2:  0.5rem;\n  --dc-space-3:  0.75rem;\n  --dc-space-4:  1rem;\n  --dc-space-5:  1.25rem;\n  --dc-space-6:  1.5rem;\n  --dc-space-8:  2rem;\n  --dc-space-10: 2.5rem;\n  --dc-space-12: 3rem;\n  --dc-space-16: 4rem;\n  --dc-space-20: 5rem;\n  --dc-space-24: 6rem;\n\n  /* === RADIUS === */\n  --dc-round-1:    0.25rem;\n  --dc-round-2:    0.5rem;\n  --dc-round-3:    0.75rem;\n  --dc-round-4:    1rem;\n  --dc-round-5:    1.5rem;\n  --dc-round-full: 9999px;\n\n  /* === SHADOWS (tinted with primary-dim) === */\n  --dc-shadow-sm: 0 4px 24px 0 rgba(96, 99, 238, 0.08);\n  --dc-shadow-md: 0 8px 40px 0 rgba(96, 99, 238, 0.12);\n  --dc-shadow-lg: 0 16px 60px 0 rgba(96, 99, 238, 0.16);\n  --dc-shadow-xl: 0 24px 80px 0 rgba(96, 99, 238, 0.22);\n\n  /* === TRANSITIONS === */\n  --dc-transition-fast: 150ms ease;\n  --dc-transition-base: 250ms ease;\n  --dc-transition-slow: 400ms ease;\n}\n\n*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }\n\nhtml {\n  font-size: 16px;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n}\n\nbody {\n  background-color: var(--dc-surface);\n  color: var(--dc-on-surface);\n  font-family: var(--dc-font-body);\n  font-size: var(--dc-body-md);\n  line-height: 1.6;\n}\n";
...
//# sourceMappingURL=index-BBzp1U1H.js.map
